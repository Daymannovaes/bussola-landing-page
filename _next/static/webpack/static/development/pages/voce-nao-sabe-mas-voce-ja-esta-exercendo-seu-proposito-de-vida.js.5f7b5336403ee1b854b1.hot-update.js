    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleScroll", function () {
      ...
      if (!ticking) {
        window.requestAnimationFrame(function () {
          ...
          console.log(finalRGB); // this.mainElement.setAttribute('style', `background-color: rgb(${finalRGB[0]}, ${finalRGB[1]}, ${finalRGB[2]}) !important;`);
...
//# sourceMappingURL=voce-nao-sabe-mas-voce-ja-esta-exercendo-seu-proposito-de-vida.js.5f7b5336403ee1b854b1.hot-update.js.map