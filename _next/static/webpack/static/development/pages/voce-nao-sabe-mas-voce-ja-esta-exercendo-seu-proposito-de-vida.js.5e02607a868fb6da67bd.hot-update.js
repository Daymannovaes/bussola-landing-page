    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleScroll", function () {
      ...
      if (!ticking) {
        window.requestAnimationFrame(function () {
          ...
          if (percentage === 0) {
            ticking = false;
            return _this.mainElement.setAttribute('style', undefined);
          }
...
//# sourceMappingURL=voce-nao-sabe-mas-voce-ja-esta-exercendo-seu-proposito-de-vida.js.5e02607a868fb6da67bd.hot-update.js.map