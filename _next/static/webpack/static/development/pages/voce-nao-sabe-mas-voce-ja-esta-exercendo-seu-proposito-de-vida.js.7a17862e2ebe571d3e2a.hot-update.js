    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleScroll", function () {
      ...
      if (!ticking) {
        window.requestAnimationFrame(function () {
          console.log('hello');
          console.log(_this.ref.current.getBoundingClientRect().top);
          ticking = false;
        });
        ticking = true;
      }
...
//# sourceMappingURL=voce-nao-sabe-mas-voce-ja-esta-exercendo-seu-proposito-de-vida.js.7a17862e2ebe571d3e2a.hot-update.js.map