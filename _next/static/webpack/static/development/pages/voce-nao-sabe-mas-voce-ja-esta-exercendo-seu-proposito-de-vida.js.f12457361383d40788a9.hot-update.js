...
function (_Component) {
  ...
  function PostImgColored(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleScroll", function () {
      ...
      if (!ticking) {
        window.requestAnimationFrame(function () {
          ...
          console.log(_this.getDistanceFromMidPercentage(_this.getPercentageHeight()));
          ticking = false;
        });
        ticking = true;
      }
    ...
    _this.startPercentage = 0.6;
    _this.endPercentage = 0.2;
  ...
  _createClass(PostImgColored, [{
    ...
    value: function componentDidMount() {
      ...
      var initialBgColor = hexToRgb(window.getComputedStyle(mainElement, null)['background-color']);
      this.initialRGB = extractColorFromString(initialBgColor);
...
//# sourceMappingURL=voce-nao-sabe-mas-voce-ja-esta-exercendo-seu-proposito-de-vida.js.f12457361383d40788a9.hot-update.js.map