...
function (_Component) {
  ...
  function PostImgColored(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getDistanceFromMidPercentage", function (height) {
      ...
      var percentDiff = 1 - Math.pow(dist, 6) / Math.pow(_this.halfRange, 6);
...
//# sourceMappingURL=voce-nao-sabe-mas-voce-ja-esta-exercendo-seu-proposito-de-vida.js.e4021aee0d0c3dd754ca.hot-update.js.map