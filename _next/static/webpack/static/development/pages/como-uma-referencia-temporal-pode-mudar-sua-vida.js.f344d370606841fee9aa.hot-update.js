    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleScroll", function () {
      if (!_this.ticking) {
        ...
        window.requestAnimationFrame(function () {
          ...
          _this.mainElement.setAttribute('style', "background-color: rgb(".concat(finalRGB[0], ", ").concat(finalRGB[1], ", ").concat(finalRGB[2], ") !important; color: rgb(").concat(_this.props.textColor[0], ", ").concat(_this.props.textColor[1], ", ").concat(_this.props.textColor[2], ") !important;"));
...
//# sourceMappingURL=como-uma-referencia-temporal-pode-mudar-sua-vida.js.f344d370606841fee9aa.hot-update.js.map